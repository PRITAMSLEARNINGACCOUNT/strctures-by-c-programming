...
void display(bday_data *input, int num)
{
    ...
    if (strlen(string) == 5)
    {
        ...
        for (int ia = 2; ia < num; ia++)
        {
            ...
            if (a2 > input[ia].month)
            {
                a2 = input[ia].month;
                strcpy(temp2, input[ia].name);
                strcpy(string, notequal);
            }
        }
    }
    ...
    if (strlen(string) == 5)
    {
        ...
        for (int iaa = 2; iaa < num; iaa++)
        {
            ...
            if (a2 > input[iaa].month)
            {
                a2 = input[iaa].month;
                strcpy(temp2, input[iaa].name);
                strcpy(string, notequal);
            }
        }
    }
    if (strlen(temp) > 2)
    {
        printf("So %s person is older among the others given by the user\n", temp);
    }
    if (strlen(temp2) > 2)
    {
        printf("And %s person is The most younger among the others given by the user\n", temp2);
    }
}
int main()
{
